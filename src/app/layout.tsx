...
export const metadata: Metadata = {
  title: {
    default: "AyyanTech – Innovative Electronics & Smart Tech Accessories | ayyantech.net",
  ...
  openGraph: {
    ...
    siteName: "AyyanTech",
    images: [{ url: "/Ayyan Logo(1).png", width: 1200, height: 630, alt: "AyyanTech Logo" }],
    locale: "en_US",
    type: "website",
  },
  twitter: {
  ...
  alternates: { canonical: "https://ayyantech.net" },
  robots: {
    index: true,
    follow: true,
      ...
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Organization",
            name: "AyyanTech",
            alternateName: ["Ayyan Technology", "Ayyan Innovations", "ayyantech"],
            url: "https://ayyantech.net",
            logo: logos.main || "https://ayyantech.net/Ayyan Logo(1).png",
            description: "AyyanTech is a professional supplier of smart, reliable and innovative smartphone accessories and electronics since 2015.",
            foundingDate: "2015",
            sameAs: [
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            potentialAction: {
              "@type": "SearchAction",
              target: { "@type": "EntryPoint", urlTemplate: "https://ayyantech.net/products?search={search_term_string}" },
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "BreadcrumbList",
            itemListElement: [{ "@type": "ListItem", position: 1, name: "AyyanTech Home", item: "https://ayyantech.net" }],
          }),
        }} />

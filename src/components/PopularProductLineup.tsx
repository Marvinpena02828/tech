...
export default function PopularProductLineup() {
  ...
  return (
    ...
    >
      ...
      <Link
        href="/products"
        className="flex justify-center mt-6 md:mt-8 px-8 md:px-12 py-2.5 md:py-3 button-animation w-fit mx-auto rounded-full transition-colors text-sm md:text-base text-gray-900 border-2 border-gray-900"

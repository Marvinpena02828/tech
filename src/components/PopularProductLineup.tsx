...
export default function PopularProductLineup() {
  ...
  return (
    ...
    >
      ...
      <div className="hidden sm:block relative  container">
        ...
        >
          ...
          <ChevronRight size={24} className="absolute right-2" />
               ...
               <h2 style={{ fontSize: "2rem", fontWeight: "bold", textAlign: "center", color: "#111827" }}>Popular Product Lineup</h2>
      ...
      <Link
        href="/products"
        className="flex justify-center mt-6 md:mt-8 px-8 md:px-12 py-2.5 md:py-3 w-fit mx-auto rounded-full transition-all text-sm md:text-base bg-red-600 text-white border-2 border-red-600"
        onMouseEnter={(e) => {
          e.currentTarget.style.backgroundColor = "white";
          e.currentTarget.style.color = "#e40014";
          e.currentTarget.style.borderColor = "#e40014";
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.backgroundColor = "#e40014";

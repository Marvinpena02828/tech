...
export default function PopularProductLineup() {
  ...
  return (
    ...
    >
      ...
      <Link
        href="/products"
        className="flex justify-center mt-6 md:mt-8 px-8 md:px-12 py-2.5 md:py-3 w-fit mx-auto rounded-full transition-all text-sm md:text-base bg-red-600 hover:bg-red-700 text-white shadow-md hover:shadow-lg"
      >
        View All
      </Link>
    </section>

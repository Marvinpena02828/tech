  ...
  return (
    <>
      ...
      >
            ...
            <div className="md:col-span-1 footer-column">
              ...
              <ul className="space-y-2">
                {footerLinks.Company.map((link, index) => (
                  <li key={link.label} style={{ animation: `fadeInLeft 0.5s ease-out ${0.2 + index * 0.05}s forwards`, opacity: 0 }}>
                    <Link
                      href={link.href}
                      className="text-sm text-white text-opacity-90 hover:text-opacity-100 transition-all duration-300 font-arial"
                    >
                ...
                {socialLinks.map((social) => {
                  return (
                    <Link
                      ...
                      key={social.name}
                      href={social.href}
                      className="aspect-square border border-white border-opacity-50 flex items-center justify-center hover:bg-white hover:bg-opacity-10 hover:scale-105 transition-all duration-300 group social-icon"
        ...
        {/* Bottom Section */}
        <div className="w-full max-w-7xl mx-auto fade-in-up" style={{ animationDelay: "0.6s", opacity: 0 }}>
        ...
        <div className="fixed bottom-8 right-8 z-50 fade-in-scale" style={{ animationDelay: "0.7s", opacity: 0 }}>
          <button
